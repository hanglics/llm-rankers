...
\caption{Comparison of setwise ranking strategies. \topdown{} returns only the best document, \bottomup{} only the worst, and \dualend{} both, yielding about $1.79\times$ more ranking information per call.}
\label{fig:overview}
\end{figure}
