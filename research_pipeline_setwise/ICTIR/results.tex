...
\begin{table*}[!htbp]
\caption{Main results on TREC DL 2019 and 2020 (NDCG@10 and MAP@100). Best NDCG@10 result per model in \textbf{bold}, second-best \underline{underlined}. All use \texttt{num\_child}=3, $k$=10, hits=100. The full 8-method block is shown for every model.}
\label{tab:main}
\scriptsize
