...
- v4 (2026-05-07) — re-aligned to canonical root docs after the EMNLP isolation restructure (`../../EMNLP_PAPER_DESIGN.md` v5, `../../EMNLP_EXPERIMENT_PLAN.md`, `../../EMNLP_IMPLEMENTATION_PLAN.md` v4):
  - **Cross-reference cleanup:** title and root-canonical refs corrected after the over-broad sed during the EMNLP isolation restructure mangled `EXPERIMENT_PLAN.md` paths into `Extra-Experiments/EXPERIMENT_PLAN.md`. All paper/v1 refs now point at the post-restructure root locations.
