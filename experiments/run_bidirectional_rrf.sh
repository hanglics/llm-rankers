...
#SBATCH -o /scratch/project/neural_ir/hang/llm-rankers/logs/qwen3-4b-3-10-100-512-dl20-bidirectional_rrf.output
#SBATCH -e /scratch/project/neural_ir/hang/llm-rankers/logs/qwen3-4b-3-10-100-512-dl20-bidirectional_rrf.error
