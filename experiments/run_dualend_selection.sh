...
#SBATCH --mem=512G
#SBATCH --job-name=dese
#SBATCH --partition=gpu_cuda
#SBATCH --qos=gpu
#SBATCH --gres=gpu:h100:1
#SBATCH --time=10:00:00
#SBATCH --account=a_ai_collab
#SBATCH -o /scratch/project/neural_ir/hang/llm-rankers/logs/qwen3-4b-3-10-100-512-dl20-dualend_select.output
#SBATCH -e /scratch/project/neural_ir/hang/llm-rankers/logs/qwen3-4b-3-10-100-512-dl20-dualend_select.error
