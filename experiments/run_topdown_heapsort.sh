...
#SBATCH -o /scratch/project/neural_ir/hang/llm-rankers/logs/qwen3-4b-3-10-100-512-dl20-topdown_heapsort.output
#SBATCH -e /scratch/project/neural_ir/hang/llm-rankers/logs/qwen3-4b-3-10-100-512-dl20-topdown_heapsort.error
