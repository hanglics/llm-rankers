...
#
# Conda env per model is resolved here and propagated to the launcher via
# sbatch --export=ALL,CONDA_ENV=...; ranker_env for Qwen3 / flan-t5,
# qwen35_env for Qwen3.5. (Legacy: manual edit of the launcher is no
# longer required.)

set -e

CONDA_ENV_RANKER="/scratch/project/neural_ir/hang/llm-rankers/ranker_env"
CONDA_ENV_QWEN35="/scratch/project/neural_ir/hang/llm-rankers/qwen35_env"
...
# Qwen3 models (passage_length=512) — ranker_env
