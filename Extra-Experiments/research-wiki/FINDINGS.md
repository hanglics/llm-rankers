...
- Hard framing constraints from claim:C10 (in `claims/C10_framing_ictir_conservative.md`):
...
- Added a self-contained significance workflow in [analysis/significance_tests.py](/Users/hangli/projects/llm-rankers/analysis/significance_tests.py) and saved the paper-facing report in [SIGNIFICANCE_TESTS.md](SIGNIFICANCE_TESTS.md)
