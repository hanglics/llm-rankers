...
> **Companion knowledge base:** the structured wiki at `ideas/` indexes all 7 ideas with stage / outcome / claim links. This report is the prose narrative for ideas 001-003 (Stage 1) plus the §"Stage-2+ Idea Refinements" appendix below.
...
- **Wiki idea pages:** `ideas/idea_001_bottomup.md` … `ideas/idea_007_maxcontext_dualend.md`
...
- **This report:** [`IDEA_REPORT.md`](IDEA_REPORT.md)

---

## Stage-1 Outcomes (added April 2026)

The original ideas 1-3 ran the full main-experiments pipeline. Outcomes per the wiki at `claims/`:
...
- **wiki:** `ideas/idea_004_selective_dualend.md`
...
- **wiki:** `ideas/idea_005_bias_aware_dualend.md`
...
- **wiki:** `ideas/idea_006_samecall_regularized.md`
...
- **wiki:** `ideas/idea_007_maxcontext_dualend.md`
